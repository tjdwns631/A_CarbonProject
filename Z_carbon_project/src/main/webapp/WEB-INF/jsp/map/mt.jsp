											...
											var point_feature = new ol.Feature(
													{
														geometry : new ol.geom.Point(
																[
																		json.data.response.data[i].coordx,
																		json.data.response.data[i].coordy ]),
												...
												view : new ol.View(
														{
															...
															center : point_feature.values_.geometry.flatCoordinates
														// 선택한 도로 좌표값
														}),
												target : 'map',
												layers : [
