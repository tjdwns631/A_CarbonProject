...
<body>
	...
	<nav>
		<ul class="nav_wrap">
			<!-- 대시보드 -->
			<li class="nav_list depth1" onclick="location.href='${pageContext.request.contextPath}/dashboard.do';">
	...
	<div class="bot">
		...
		<button class="logout"  onclick="location.href='${pageContext.request.contextPath}/logout.do';">LOGOUT</button>
	</div>
	<script>
